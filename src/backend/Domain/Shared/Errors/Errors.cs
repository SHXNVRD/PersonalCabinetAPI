...
public static class Errors
{
    ...
    {
        public const string CurrentStatusMetadataKey = "CurrentStatus";
        
        public static ConflictError CannotSetCardStatus(Status currentStatus, string message = "Status cannot be settled")
            => (ConflictError)new ConflictError(message, ErrorCode.CannotSetCardStatus).WithMetadata(CurrentStatusMetadataKey, currentStatus);
        ...
        public static ConflictError FuelIsForbidden(string message = "Fuel is forbidden for this card")
            => new ConflictError(message, ErrorCode.FuelIsForbidden);
        ...
        public static ConflictError InvalidCurrentCardStatus(Status currentStatus, string message = "Unable to perform an action with the current card status")
            => (ConflictError)new ConflictError(message, ErrorCode.InvalidStatus).WithMetadata(CurrentStatusMetadataKey, currentStatus);

        public static ConflictError CannotRefundPurchase(string message = "Cannot refund purchase")
    ...
    {
        public static NotFoundError EntityNotFound(string message = "Entity not found")
